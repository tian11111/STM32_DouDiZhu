...
static void touchpad_read(lv_indev_t *indev_drv, lv_indev_data_t *data)
{
    ...
    if (touchpad_is_pressed())
    {
        ...
        printf("LVGL Touch: PRESSED at X=%ld, Y=%ld\r\n", last_x, last_y);
    }
    else
    {
...
static void touchpad_get_xy(int32_t *x, int32_t *y)
{
    ...
    XPT2046_Read(&x_raw, &y_raw);
    /* Transform portrait 240x320 -> landscape 320x240 (MADCTL=0x68: MV=1, MX=1) */
    *x = (int32_t)y_raw;
    *y = (int32_t)(239 - x_raw);
}
